...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HealthlyBurger healthlyBurger = new HealthlyBurger ("mięso sojowe", 13);
        healthlyBurger.addHamburgerAddition5 ("Kiszonka", 11);
        System.out.println ("Total healthly Burger price is " + healthlyBurger.itemizeHamburger ( ));
        DeluxeBurger deluxeBurger = new DeluxeBurger ("Delux meat", 2.3, "Bułka z kosmosu");
        System.out.println ("Deluxe: " + deluxeBurger.itemizeHamburger ());
      //  deluxeBurger.
